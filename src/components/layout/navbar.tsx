          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                type="text"
                placeholder="Search"
                className="pl-10 pr-4 py-2 bg-linkedin-warm-gray rounded-md text-sm w-64 focus:outline-none focus:ring-2 focus:ring-linkedin-blue"
              />
            </div>
          </div>

          <div className="flex items-center gap-1 md:gap-6">
            <NavLink href="/feed" icon={Home} label="Home" />
            <NavLink href="/network" icon={Users} label="My Network" />
            <NavLink href="/jobs" icon={Briefcase} label="Jobs" />
            <NavLink href="/messaging" icon={MessageSquare} label="Messaging" />
...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className="flex flex-col items-center text-linkedin-text-gray hover:text-linkedin-text-dark"
    >
